...
syntax match crontabDow "\s[-a-z0-9/,.*]\+" nextgroup=crontabUser skipwhite contained
syntax keyword crontabDow7 contained sun mon tue wed thu fri sat

syntax match crontabUser "\s[-_a-z0-9.]\+" nextgroup=crontabCmd skipwhite contained
...
syntax match crontabNick "^\s*@\(reboot\|yearly\|annually\|monthly\|weekly\|daily\|midnight\|hourly\)\>" nextgroup=crontabUser skipwhite
